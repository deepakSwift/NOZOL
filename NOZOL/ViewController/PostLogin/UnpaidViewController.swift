...
class UnpaidViewController: UIViewController,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        self.getunPaidCategory(category: "4")
    ...
    func getunPaidCategory(category : String){
